...
const Seconddiff = () => {
  ...
  const calculate = () => {
    ...
    const funcdiff = (x) => derivative(derivative(Equation, 'x'), 'x').evaluate({ x });

    if (error == "O(h)" && direction == "Forward") {
      // console.log(x);
      // console.log(h);

      let diffanswer = (func(x + h * 2) - 2 * func(x + h) + func(x)) / Math.pow(h, 2);
      ...
      let diffanswer = (func(x) - 2 * func(x - h) + func(x - h * 2)) / Math.pow(h, 2);
      console.log(diffanswer);
      ...
      let diffanswer = (func(x + h) - 2 * func(x) + func(x - h)) / Math.pow(h, 2);
      console.log(diffanswer);
      ...
      let diffanswer = (-(func(x + h * 3)) + (4 * (func(x + h * 2))) - 5 * func(x + h) + (2 * (func(x)))) / Math.pow(h, 2);
      console.log(diffanswer);
      console.log(func(x))
      ...
      let diffanswer = ((2 * func(x)) - 5 * func(x - h) + 4 * func(x - h * 2) - func(x - h * 3)) / Math.pow(h, 2);
      console.log(diffanswer);
      ...
      let diffanswer = (-func(x + h * 2) + (16 * func(x + h)) - 30 * func(x) + 16 * func(x - h) - func(x - h * 2)) / (12 * (Math.pow(h, 2)));
      console.log(diffanswer);

...
const Forthdiff = () => {
  ...
  const calculate = () => {
    ...
    const funcdiff = (x) => derivative(derivative(derivative(derivative(Equation, 'x'), 'x'), 'x'), 'x').evaluate({ x });

    if (error == "O(h)" && direction == "Forward") {
      // console.log(x);
      // console.log(h);

      let diffanswer = (func(x + h * 4) - 4 * func(x + h * 3) + 6 * func(x + h * 2) - 4 * func(x + h) + func(x)) / Math.pow(h, 4);
      ...
      let diffanswer = (func(x) - 4 * func(x - h) + 6 * func(x - h * 2) - 4 * func(x - h * 3) + func(x - h * 4)) / Math.pow(h, 4);
      console.log(diffanswer);
      ...
      let diffanswer = (func(x + h * 2) - 4 * func(x + h) + 6 * func(x) - 4 * func(x - h) + func(x - h * 2)) / Math.pow(h, 4);
      console.log(diffanswer);
      ...
      let diffanswer = (-2 * (func(x + h * 5)) + (11 * (func(x + h * 4))) - 24 * func(x + h * 3) + (26 * (func(x + h * 2))) - 14 * func(x + h) + 3 * func(x)) / Math.pow(h, 4);
      console.log(diffanswer);
      ...
      let diffanswer = ((3 * func(x)) - 14 * func(x - h) + 26 * func(x - h * 2) - 24 * func(x - h * 3) + 11 * func(x - h * 4) - 2 * func(x - h * 5)) / Math.pow(h, 4);
      console.log(diffanswer);
      ...
      let diffanswer = (-func(x + h * 3) + (12 * func(x + h * 2)) - 39 * func(x + h) + 56 * func(x) - 39 * func(x - h) + 12 * func(x - h * 2) - func(x - h * 3)) / (6 * (Math.pow(h, 4)));
      console.log(diffanswer);
      ...
      <div className='h-screen bg-stone-200'>
        ...
        <div className='mt-5 h-[5rem] flex flex-col items-center justify-center pb-[2%]'>
          <ul className="classmenu menu menu-lg bg-white rounded-box w-[80%] gap-[0.5%] shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] flex flex-row">
            ...
            <li className='hover:bg-red-400 rounded-box  bg-red-500 text-white w-[32.5%] '>

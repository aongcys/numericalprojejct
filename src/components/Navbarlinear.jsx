        ...
        <div className='h-[6rem] bg-black rounded-b-xl grid grid-cols-4 gap-0'>
          ...
          <div className="flex col-span-2">
            <div className="dropdown dropdown-hover ml-[13rem]">
              <div tabIndex={0} role="button" className="btn bg-white h-[3.5rem] m-5 text-lg py-3 px-10 text-[2.5rem] font-normal w-[25rem]" >Linear Algebra Equeation</div>
